...
final class CategoriesRegionsAdsCount extends AbstractMigration
{
    ...
    {
        $this->log('Update 1');
        $this->execute("IF NOT EXISTS( SELECT NULL
            FROM INFORMATION_SCHEMA.COLUMNS
           WHERE table_name = 'categories_regions_with_ads'
             AND table_schema = '" . \Palto\Config::get('DB_NAME') . "'
             AND column_name = 'ads_count')  THEN ALTER TABLE `categories_regions_with_ads` ADD `ads_count` int unsigned NOT NULL DEFAULT '0';");
