...
<head>
    ...
    <meta name="description" content="<?=$this->translate($description ?? '')?>">
                            ...
                            <table class="tbl_menu">
                                <tr>
                                    <td>
                                        ...
                                        <?php foreach (Categories::getLiveCategories(null, $region ?? null, \Palto\Config::get('HEADER_LAYOUT_MENU')) as $popularLevel1Category) :?>
                                            <a class="menu" href="<?=$popularLevel1Category->generateUrl($region ?? null)?>" rel="nofollow"><?=$popularLevel1Category->getTitle()?></a> <span class="whitem">|</span>
                                        <?php endforeach;?>
                                    </td>
                                    <td align="righ">
                                        <strong>
