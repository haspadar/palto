...
<?php if ($ad->getRegion()): ?>
    📍 <?= $this->translate('Регион') ?>: <a
            href="<?= $ad->getRegion()->generateUrl() ?>"><?= $ad->getRegion()->getTitle() ?></a>
<?php endif; ?>
...
<?php if ($ad->getSellerPhone()) : ?>
    <div class="phone">📞 <a class="show-phone phone" id="show-phone" data-phone="<?= $ad->getSellerPhone() ?>"
...
<?php endif; ?>
    ...
    <div class="report"><a class="report_link" href="javascript:void(0);"
                           id="send-abuse">⚠️ <?= $this->translate('Пожаловаться на объявление') ?></a></div>
